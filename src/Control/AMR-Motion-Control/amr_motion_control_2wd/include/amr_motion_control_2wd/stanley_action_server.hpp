...
#include "amr_interfaces/action/amr_motion_stanley.hpp"
#include "amr_interfaces/srv/update_stanley_path.hpp"
...
class StanleyActionServer
{
public:
  using Stanley     = amr_interfaces::action::AMRMotionStanley;
  using GoalHandle  = rclcpp_action::ServerGoalHandle<Stanley>;
  using UpdatePath  = amr_interfaces::srv::UpdateStanleyPath;
  ...
  explicit StanleyActionServer(rclcpp::Node::SharedPtr node);
...
private:
  ...
  rclcpp_action::Server<Stanley>::SharedPtr action_server_;
  ...
  double default_K_stanley_;
  double default_K_soft_;
